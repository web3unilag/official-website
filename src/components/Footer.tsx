      ...
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center md:items-start gap-8 mb-12">
          ...
          <div className="w-full">
            <h4 className="text-base text-white/70 font-semibold mb-4">Socials</h4>
            <div className="space-y-4">
              <a
                href="https://x.com/web3unilag"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-3 text-white hover:text-white/70 transition-colors group w-fit"
              >
                <div className="bg-white/10 p-2 rounded-lg group-hover:bg-white/20 transition-colors flex-shrink-0">
                  <svg width="16" height="14" viewBox="0 0 44 41" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span className="text-sm font-medium whitespace-nowrap">Follow us on X</span>
              </a>
              ...
              >
                <div className="bg-white/10 p-2 rounded-lg group-hover:bg-white/20 transition-colors flex-shrink-0">
                  <svg width="16" height="12" viewBox="0 0 48 37" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <span className="text-sm font-medium whitespace-nowrap">Join our Discord</span>
              </a>
            </div>
          </div>
        </div>
