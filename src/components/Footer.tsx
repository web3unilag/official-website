  ...
  return (
    <footer className="gradient-footer text-white py-8 sm:py-12">
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start gap-8 sm:gap-12 mb-8 sm:mb-12">
          ...
          <div className="w-full lg:w-1/3 text-center lg:text-left mb-8 lg:mb-0">
            ...
            <div className="flex items-center justify-center lg:justify-start gap-x-2">
              ...
              <p className="text-xs sm:text-sm text-white/70">Lagos, Nigeria.</p>
            </div>
          </div>
          ...
          <div className="w-full lg:w-2/3 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            <div className="text-center sm:text-left">
              ...
              <ul className="space-y-2 sm:space-y-3">
                <li><a href="#" className="text-white hover:text-white/70 text-xs sm:text-sm transition-colors block">About Us</a></li>
                <li><a href="#" className="text-white hover:text-white/70 text-xs sm:text-sm transition-colors block">Programs</a></li>
                <li><a href="#" className="text-white hover:text-white/70 text-xs sm:text-sm transition-colors block">Events</a></li>
                <li><a href="#" className="text-white hover:text-white/70 text-xs sm:text-sm transition-colors block">Team</a></li>
              </ul>
            </div>
            <div className="text-center sm:text-left">
              <h4 className="text-sm sm:text-base text-white/70 font-semibold mb-3 sm:mb-4">Resources</h4>
              <ul className="space-y-2 sm:space-y-3">
                <li><a href="https://web3unilag.substack.com/" target="_blank" rel="noopener noreferrer" className="text-white hover:text-white/70 text-xs sm:text-sm transition-colors block">Blog</a></li>
                <li><a href="https://drive.google.com/drive/folders/1tH-BtLtmhnIxc2t60hvU4UHnm6JWBDlo" target="_blank" rel="noopener noreferrer" className="text-white hover:text-white/70 text-xs sm:text-sm transition-colors block">Brand Assets</a></li>
                <li><a href="#programs" className="text-white hover:text-white/70 text-xs sm:text-sm transition-colors block">Programs</a></li>
                <li><a href="#contact" className="text-white hover:text-white/70 text-xs sm:text-sm transition-colors block">Contact</a></li>
              </ul>
            </div>
          ...
          <div className="w-full text-center sm:text-left">
            ...
            <div className="space-y-3 sm:space-y-4 flex flex-col items-center sm:items-start">
              ...
              >
                ...
                <span className="text-xs sm:text-sm font-medium">Follow us on X</span>
              </a>
              ...
              >
                ...
                <span className="text-xs sm:text-sm font-medium">Join our Discord</span>
              </a>
            </div>
          </div>
        </div>
        ...
        {/* Copyright */}
        <div className="flex flex-col sm:flex-row justify-between items-center text-xs sm:text-sm text-white/50 text-center sm:text-left">
